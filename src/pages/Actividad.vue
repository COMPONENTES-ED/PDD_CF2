      ...
      >
        <div class="col-6 col-md-4 col-lg-3 mb-4 mb-md-0">
          <div class="tarjeta h-100 d-flex align-items-center p-4">
            <figure>
              <img src="@/assets/curso/Falso_Verdadero.svg" alt="" />
            </figure>
          </div>
        </div>
        <div class="col-12 col-md-8 col-lg-9">
          ...
          <p class="mb-4">
            Validar el conocimiento adquirido sobre Integración y gestión
            avanzada de datos para inteligencia artificial. Esto se trabaja a
